...
import type { FileRow, ListItem, Note, NoteStatus, NoteType } from './types'

function nowIso() {
  return new Date().toISOString()
}

// --- Tags helpers (DB stores TEXT JSON: '["a","b"]') ---
...
export async function updateNote(
  ...
  // Always bump updated_at if anything is being updated
  values.push(nowIso())
